...
!(function (e, t) {
        ...
        return (
          ...
          se(function (o, a, s, u) {
            var l,
              ...
              v = n ? (i || (o ? e : h || r) ? [] : a) : m;
            if ((n && n(m, v, s, u), r))
              for (l = be(v, d), r(l, [], s, u), c = l.length; c--; )
                (f = l[c]) && (v[d[c]] = !(m[d[c]] = f));
            if (o) {
              if (i || e) {
                if (i) {
  ...
  function D(e, t, n) {
    ...
    if ("string" == typeof t) {
      if (N.test(t)) return m.filter(t, e, n);
      t = m.filter(t, e);
    }
    return m.grep(e, function (e) {
  ...
  (m.filter = function (e, t, n) {
    ...
    m.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && E.test(e) ? m(e) : e || [], !1)
          .length;
      },
    });
  var j,
      ...
      function (e, t) {
        m.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (L[e] || m.uniqueSort(i), q.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
  ...
  (m.Callbacks = function (e) {
    ...
    m.extend({
        ...
        var n = [
          ...
          i = {
            ...
            then: function (t, r, i) {
              ...
              return m
                .Deferred(function (e) {
                  n[0][3].add(a(0, e, m.isFunction(i) ? i : O, e.notifyWith)),
                    n[1][3].add(a(0, e, m.isFunction(t) ? t : O)),
                    n[2][3].add(a(0, e, m.isFunction(r) ? r : P));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (R(e, a.done(s(n)).resolve, a.reject),
    ...
    m.extend({
      ...
      ready: function (e) {
        (!0 === e ? --m.readyWait : m.isReady) ||
          ((m.isReady = !0),
          (!0 !== e && --m.readyWait > 0) || I.resolveWith(r, [m]));
      },
    }),
    (m.ready.then = I.then),
          ...
          if (
            ...
            for (n = a.length; n--; )
              a[n] &&
                ...
                ((r = m.camelCase(r.slice(5))), G(o, r, i[r]));
  ...
  function ee(e, t, n, r) {
    var i,
      ...
      c = (m.cssNumber[t] || ("px" !== l && +u)) && Q.exec(m.css(e, t));
    if (c && c[3] !== l) {
      (l = l || c[3]), (n = n || []), (c = +u || 1);
      do {
  ...
  (ce = r.createDocumentFragment().appendChild(r.createElement("div"))),
  ...
  (m.event = {
    ...
    remove: function (e, t, n, r, i) {
      ...
      if (v && (u = v.events)) {
        ...
        m.isEmptyObject(u) && z.remove(e, "handle events");
      }
    },
    dispatch: function (e) {
      var t,
  ...
  function Ae(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      X.hasData(e) && ((s = X.access(e)), (u = m.extend({}, s)), X.set(t, u));
    }
  }
  function qe(e, t, n, r) {
    t = a.apply([], t);
    ...
    if (
      ...
      for (u = (s = m.map(ue(i, "script"), De)).length; f < p; f++)
        (l = i),
          f !== d &&
            ((l = m.clone(l, !0, !0)), u && m.merge(s, ue(l, "script"))),
          n.call(e[f], l, f);
      if (u)
  ...
  function Le(e, t, n) {
    for (var r, i = t ? m.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || m.cleanData(ue(r)),
        r.parentNode &&
          (n && m.contains(r.ownerDocument, r) && le(ue(r, "script")),
  ...
  m.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (a = ue(c, "script")).length > 0 && le(a, !f && ue(e, "script")), c
      );
    },
    ...
    m.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (m.cleanData(ue(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (m.cleanData(ue(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return qe(
          ...
          function (t) {
            ...
            m.inArray(this, e) < 0 &&
              (m.cleanData(ue(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
  ...
  function Xe(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (a += m.css(e, n + J[o], !0, i)),
        r
          ? ("content" === n && (a -= m.css(e, "padding" + J[o], !0, i)),
            "margin" !== n && (a -= m.css(e, "border" + J[o] + "Width", !0, i)))
          : ((a += m.css(e, "padding" + J[o], !0, i)),
            "padding" !== n &&
              (a += m.css(e, "border" + J[o] + "Width", !0, i)));
    return a;
  }
  function Ue(e, t, n) {
    var r,
    ...
    if (
      ...
      if (
        (((r = Pe(e, t, o)) < 0 || null == r) && (r = e.style[t]), Fe.test(r))
      )
        return r;
  ...
  m.extend({
    ...
    m.each(["height", "width"], function (e, t) {
      m.cssHooks[t] = {
        get: function (e, n, r) {
          if (n)
            return !Me.test(m.css(e, "display")) ||
    ...
    tweeners: {
      "*": [
        function (e, t) {
          ...
          return ee(n.elem, e, Q.exec(t), n), n;
        },
      ],
    },
    tweener: function (e, t) {
      m.isFunction(e) ? ((t = e), (e = ["*"])) : (e = e.match(F));
        ...
        if ((u = !m.isEmptyObject(t)) || !m.isEmptyObject(d))
          ...
          d))
            u ||
              ...
              g && re([e], !0),
              p.done(function () {
                for (r in (g || re([e]), z.remove(e, "fxshow"), d))
                  m.style(e, r, d[r]);
              })),
              (u = tt(g ? v[r] : 0, r, p)),
              r in v ||
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            var t, r, i, o;
            if ("string" === n)
              for (r = 0, i = m(this), o = e.match(F) || []; (t = o[r++]); )
                i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
            else
              (void 0 !== e && "boolean" !== n) ||
                ((t = ut(this)) && z.set(this, "__className__", t),
                this.setAttribute &&
                  this.setAttribute(
                    "class",
      ...
      if (
        ...
        for (a = 0; (s = h[a++]) && !t.isPropagationStopped(); )
          (t.type = a > 1 ? l : d.bindType || g),
            (p = (z.get(s, "events") || {})[t.type] && z.get(s, "handle")) &&
              p.apply(s, n),
            (p = c && s[c]) &&
              p.apply &&
              B(s) &&
  ...
  m.ajaxSetup({
    ...
    m.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (s || "jsonp" === t.dataTypes[0])
        return (
          (i = t.jsonpCallback = m.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s
    ...
    (h.createHTMLDocument =
      (((Ot = r.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
      2 === Ot.childNodes.length)),
    ...
    m.each(["top", "left"], function (e, t) {
      m.cssHooks[t] = Re(h.pixelPosition, function (e, n) {
        if (n)
          return (n = Pe(e, t)), Fe.test(n) ? m(e).position()[t] + "px" : n;
      });
    }),
    m.each({ Height: "height", Width: "width" }, function (e, t) {
      m.each({ padding: "inner" + e, content: t, "": "outer" + e }, function (
        n,
        r
      ) {
        m.fn[r] = function (i, o) {
